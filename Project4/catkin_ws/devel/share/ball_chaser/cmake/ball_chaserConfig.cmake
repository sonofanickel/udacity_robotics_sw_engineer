...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/install)
...
if(NOT "/home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'mike <michael.s.nicholson@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/devel/lib;/home/mike/udacity_robotics_sw_engineer/Project4/catkin_ws/devel/lib;/opt/ros/noetic/lib)
